...
class Game {
    ...
    static main(environment) {
        ...
        // start the game
        const gameLevelClasses = [GameLevelBasement, GameLevelMC, GameLevelForest]
    ...
    static showInstructions(callback) {
        ...
        instructionsDiv.innerHTML = `
            <h2 style="color: #f5c207; margin-bottom: 15px; text-align: center;">Delusion Game 2.0</h2>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <p>• Ask Asaka guestions!</p>
                <p>• Mess around with Miku!</p>
                <p>• Find Nico's Secret Level with Nezuko!</p>
            </div>
